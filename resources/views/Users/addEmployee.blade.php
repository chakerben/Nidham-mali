                        ...
                        <div class="col-md-12">
                            ...
                            <div class="portlet light ">
                                ...
                                <div class="portlet-body">
                                    @empty($employee) <form action="/employees" method="POST"> @endempty
                                    @isset($employee)
                                    ...
                                    @endisset
                                        ...
                                        <div class="col-md-6 col-md-offset-3 col-sm-12">
                                            ...
                                            <input type="text" class="form-control" name="name" id="name" @isset($employee) value="{{$employee->name}}" @endisset placeholder=""> 
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6 col-md-offset-3 col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" rows="5" name="details" id="details">
                                                    @isset($employee) {{$employee->details}} @endisset
                                                </textarea>
                                            </div>
                                        </div>
