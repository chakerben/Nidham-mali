                        ...
                        <div class="col-md-12">
                            ...
                            <div class="portlet light ">
                                ...
                                <div class="portlet-body">
                                    @empty($employee) <form action="/employees" method="POST" id="formEmployee"> @endempty
                                    @isset($employee)
                                        <form action="/employees/{{ $employee->id }}" method="POST" id="formEmployee"> 
                                        @method('PUT')
                                    @endisset
                                        @csrf
                                                ...
                                                <div class="fileinput fileinput-new" data-provides="fileinput">
                                                    <div class="input-group input-large">
                                                        ...
                                                        <span class="input-group-addon btn default btn-file">
                                                            ...
                                                            <input type="file" name="..." @isset($employee->file) value="{{ $employee->file }}" @endisset> </span>
                                        ...
                                        <div class="col-md-6 col-md-offset-3 col-sm-12">
                                            <fieldset id="paypal" style="display: none;">
                                                ...
                                                <form action="/employees/addemppaypalacount/{{ $employee->id }}" method="POST">
                                                    @csrf
                                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-md-offset-3 col-sm-12">
                                            <fieldset id="bank" style="display: none;">
                                                ...
                                                <form action="/employees/addempbankacount/{{ $employee->id }}" method="POST">
                                                    @csrf
                                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-md-offset-3 col-sm-12">
                                            <fieldset id="other" style="display: none;">
                                                ...
                                                <form action="/employees/addemptransfermethod/{{ $employee->id }}" method="POST">
                                                    @csrf
                                                    <div class="form-group">
