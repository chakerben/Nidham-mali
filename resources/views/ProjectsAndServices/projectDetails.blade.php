                                        ...
                                        <fieldset>
                                            ...
                                            <div class="col-md-4 col-xs-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-icon">
                                                        <i class="fa fa-money font-green "></i>
                                                    <input type="text" class="form-control" value="{{$project->payd}}" disabled> 
                                                    </div>
                                                </div>
                                            </div>   
                                            ...
                                            <div class="col-md-4 col-xs-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-icon">
                                                        <i class="fa fa-money font-green "></i>
                                                        <input type="text" class="form-control" value="{{$project->cost - $project->payd}}" disabled> 
                                                    </div>
                                                </div>
                                            </div>                       		
                                            ...
                                            <div class="col-md-4 col-xs-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-icon">
                                                        <i class="fa fa-money font-green "></i>
                                                        <input type="text" class="form-control" value="{{$project->dept}}" disabled> 
                                                    </div>
                                                </div>
                                            </div>
                                            
                                            @isset($project->Tranches)
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                            ...
                                                            <div class="mt-list-container list-simple ext-1 bg-white">
                                                                <ul>
                                                                    @foreach ($project->Tranches as $tranche)
                                                                        <li class="mt-list-item @if($tranche->payed) done @elseif($tranche->isLate()) late @else wait @endif">
