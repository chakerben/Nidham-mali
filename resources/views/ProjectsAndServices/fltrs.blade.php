<form action="{{route('fltrProjectsAndServices')}}" method="POST" class="filters__form nomargin">
    @csrf
    ...
    <div class="filters filters--vertical">
        <div class="filters__section filters__section--category filters__section--vertical">
            <div class="filters__section-content">
                <div>
                    <input id="checkAll" class="checkbox-style" name="checkAll" type="checkbox" checked>
                ...
                <div>
                    ...
                    <label for="checkbox-2" class="checkbox-style-3-label"> المشاريع </label>
                </div>

                <div>
                    <input id="checkbox-3" class="checkbox-style" name="checkbox-3" type="checkbox">
                    <label for="checkbox-3" class="checkbox-style-3-label"> الخدمات </label>
                </div>

                <div>
                    <input id="checkbox-4" class="checkbox-style" name="checkbox-4" type="checkbox">
                    <label for="checkbox-4" class="checkbox-style-3-label"> المشاريع الناجحة </label>
                </div>

                <div>
                    <input id="checkbox-5" class="checkbox-style" name="checkbox-5" type="checkbox">
                    <label for="checkbox-5" class="checkbox-style-3-label"> المشاريع الخاسرة </label>
                </div>

                <div>
                    <input id="checkbox-6" class="checkbox-style" name="checkbox-6" type="checkbox">
                    <label for="checkbox-6" class="checkbox-style-3-label"> المشاريع المتعادلة </label>
                </div>
                
                <div class="col-md-12"> <hr> </div>
                
                <div>
                    <input id="allTime" class="checkbox-style" name="allTime" type="checkbox">
                ...
                <div>
                    <input id="finiched" class="checkbox-style" name="finiched" type="checkbox">
                    <label for="finiched" class="checkbox-style-3-label"> المنتهية </label>
                </div>

                <div>
                    <input id="inProgres" class="checkbox-style" name="inProgres" type="checkbox">
